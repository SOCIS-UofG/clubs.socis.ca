...
export default function ClubCard(props: ClubCardProps): JSX.Element {
  ...
  return (
    <div
      className={cn(
        "btn relative flex h-fit w-full max-w-96 flex-col items-start justify-start gap-3.5 rounded-lg border border-primary bg-secondary p-6 duration-300 ease-in-out sm:w-96",
        props.className,
      )}
    >
      {/**
