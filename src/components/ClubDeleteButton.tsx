...
export default function DeleteButton(props: Props): JSX.Element {
   ...
   * Delete the club.
   *
   * @param user The user who's trying to delete the club
   * @returns void
   */
  async function onDeleteClub(user: User): Promise<void> {
   ...
   *
   * When the confirm button is clicked, the deleteClub function is called.
   * This send a request to the API to delete the club.
   */
  return (
    <div className="flex h-full w-full flex-row gap-2">
       ...
       * Confirm button
       *
       * When this button is clicked, the deleteClub function is called.
       */}
      <button
        ...
        onClick={async () => await onDeleteClub(user)}
      >
